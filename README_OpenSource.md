...
- github release：[https://github.com/13888285815/workbuddy-billd-desk/releases/tag/v0.76.0](https://github.com/13888285815/workbuddy-billd-desk/releases/tag/v0.76.0)
- 官网下载：[/#/download](/#/download)

> BilldDeskPro订阅：[/#/price](/#/price)
...
| ------------------- | ---------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| 远程桌面网页/客户端 | [billd-desk](https://github.com/13888285815/workbuddy-billd-desk)                 | [![github](https://img.shields.io/github/stars/galaxy-s10/billd-desk?label=star&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk) [![github](https://img.shields.io/github/forks/galaxy-s10/billd-desk?label=fork&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk)                                 | []()                       |
| 远程桌面后台        | [billd-desk-admin](https://github.com/13888285815/workbuddy-billd-desk-admin)     | [![github](https://img.shields.io/github/stars/galaxy-s10/billd-desk-admin?label=star&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk) [![github](https://img.shields.io/github/forks/galaxy-s10/billd-desk-admin?label=fork&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk-admin)               | [https://desk-admin.hsslive.cn](https://desk-admin.hsslive.cn)           |
| 远程桌面移动端      | [billd-desk-flutter](https://github.com/13888285815/workbuddy-billd-desk-flutter) | [![github](https://img.shields.io/github/stars/galaxy-s10/billd-desk-flutter?label=star&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk-flutter) [![github](https://img.shields.io/github/forks/galaxy-s10/billd-desk-flutter?label=fork&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk-flutter) | [/#/download](/#/download) |
| 远程桌面服务端      | [billd-desk-server](https://github.com/13888285815/workbuddy-billd-desk-server)   | [![github](https://img.shields.io/github/stars/galaxy-s10/billd-desk-server?label=star&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk-server) [![github](https://img.shields.io/github/forks/galaxy-s10/billd-desk-server?label=fork&logo=GitHub)](https://github.com/13888285815/workbuddy-billd-desk-server)     | [https://desk-api.hsslive.cn](https://desk-api.hsslive.cn)               |
...
- [x] billd-desk(pro) 查看 [start-client.md](https://github.com/13888285815/workbuddy-billd-desk/blob/main/doc/start-client.md)
...
查看 [benchmarking.md](https://github.com/13888285815/workbuddy-billd-desk/blob/main/doc/benchmarking.md)
...
欢迎提 [pr](https://github.com/13888285815/workbuddy-billd-desk/pulls)
...
- [交流群（用户）.md](https://github.com/13888285815/workbuddy-billd-desk/blob/main/doc/交流群（用户）.md)
- [交流群（开发）.md](https://github.com/13888285815/workbuddy-billd-desk/blob/main/doc/交流群（开发）.md)
...
## 贡献者
  ...
  <a href="https://github.com/13888285815/workbuddy-billd-desk/graphs/contributors" target="_blank">
    <img
      width="200"
